...
import {
  ...
  refreshForgotPasswordOtpExpiry,
  setForgotPasswordVerifiedOtp,
...
export default function ForgotPasswordOtpScreen() {
  ...
  async function verifyOtp(candidate: string) {
    ...
    try {
      ...
      setForgotPasswordVerifiedOtp(candidate)
      router.replace('/settings/forgot-password/reset')
    } catch (err) {
  ...
  async function handleResend() {
    ...
    try {
      ...
      refreshForgotPasswordOtpExpiry()
      setExpiresAt(getForgotPasswordDraft()?.otpExpiresAt ?? null)
      setOtp('')
    } catch (err) {
